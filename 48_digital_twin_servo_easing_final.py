...
##############################################################################
async def my_task():
    global servo1, servo2, servo3, servo4, servo5  # Ensure these are available
    ...
    ease_to_all([servo1, servo2, servo3, servo4, servo5],
                [home_angles[1], home_angles[2], home_angles[3], home_angles[4], home_angles[5]],
                duration=1, steps=20, easing_func=ease_in_out_cubic)
    time.sleep(1)

    ############################################################################
    #                     First Forward Bend (Gait 1)
    ############################################################################
    # Compute target angles for the first forward bend.
    ...
    ease_to_all([servo2, servo3, servo1, servo4, servo5],
                ...
                duration=1, steps=10, easing_func=ease_in_out_cubic)
    time.sleep(6)
