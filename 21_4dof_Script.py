...
async def drive_joints_from_csv(filename):
    ...
    joint_1 = UsdPhysics.DriveAPI.Get(stage.GetPrimAtPath("/worm_4dof/base_link/joint_1"), "angular")
    joint_2 = UsdPhysics.DriveAPI.Get(stage.GetPrimAtPath("/worm_4dof/link_2/joint_2"), "angular")
    joint_3 = UsdPhysics.DriveAPI.Get(stage.GetPrimAtPath("/worm_4dof/link_3/joint_3"), "angular")
    joint_4 = UsdPhysics.DriveAPI.Get(stage.GetPrimAtPath("/worm_4dof/link_4/joint_4"), "angular")
    ...
    with open(filename, mode='r') as file:
        ...
        for row in reader:
            ...
            print(f"Driving joints with values: joint_1 = {joint_1_value}, joint_2 = {joint_2_value}, joint_3 = {joint_3_value},  joint_4 = {joint_4_value}")
