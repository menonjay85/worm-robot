...
async def my_task():
	...
	await asyncio.sleep(2)
	print("Anchored tail...")
	joint_1.GetTargetPositionAttr().Set(20)
	joint_2.GetTargetPositionAttr().Set(20)
	joint_3.GetTargetPositionAttr().Set(-20)
	joint_4.GetTargetPositionAttr().Set(-20)
	joint_5.GetTargetPositionAttr().Set(-20)
	await asyncio.sleep(2)
